...
// TODO
//  Add required sign on every input fields
// prevent empty submission of form section
  ...
  return (
    <>
      ...
      <p className="text-sm font-medium mt-2">
        Complete this section with detailed information, good video and resouces
